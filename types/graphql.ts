...
export enum MediaItemSizeEnum {
  /** MediaItem with the blog_entry size */
  BlogEntry = 'BLOG_ENTRY',
  /** MediaItem with the blog_post size */
  BlogPost = 'BLOG_POST',
  /** MediaItem with the blog_post_full size */
  BlogPostFull = 'BLOG_POST_FULL',
  /** MediaItem with the blog_related size */
  BlogRelated = 'BLOG_RELATED',
  /** MediaItem with the gallery size */
  Gallery = 'GALLERY',
  /** MediaItem with the large size */
  Large = 'LARGE',
  /** MediaItem with the lightbox size */
  Lightbox = 'LIGHTBOX',
  /** MediaItem with the medium size */
  Medium = 'MEDIUM',
  /** MediaItem with the medium_large size */
  MediumLarge = 'MEDIUM_LARGE',
  /** MediaItem with the search_results size */
...
export enum MenuLocationEnum {
  ...
  /** Put the menu in the mobile_menu_alt location */
  MobileMenuAlt = 'MOBILE_MENU_ALT',
  /** Put the menu in the topbar_menu location */
  TopbarMenu = 'TOPBAR_MENU'
}
...
export enum PostStatusEnum {
  ...
  /** Objects with the trash status */
  Trash = 'TRASH',
  /** Objects with the tribe-ea-draft status */
  TribeEaDraft = 'TRIBE_EA_DRAFT',
  /** Objects with the tribe-ea-failed status */
  TribeEaFailed = 'TRIBE_EA_FAILED',
  /** Objects with the tribe-ea-pending status */
  TribeEaPending = 'TRIBE_EA_PENDING',
  /** Objects with the tribe-ea-schedule status */
  TribeEaSchedule = 'TRIBE_EA_SCHEDULE',
  /** Objects with the tribe-ea-success status */
  TribeEaSuccess = 'TRIBE_EA_SUCCESS',
  /** Objects with the tribe-ignored status */
  TribeIgnored = 'TRIBE_IGNORED'
}
...
/** The template assigned to the node */
export type Template_BlogContentAbove = ContentTemplate & {
  __typename?: 'Template_BlogContentAbove';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};

/** The template assigned to the node */
export type Template_FullScreen = ContentTemplate & {
  __typename?: 'Template_FullScreen';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};

/** The template assigned to the node */
export type Template_LandingPage = ContentTemplate & {
  __typename?: 'Template_LandingPage';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};
...
/** The template assigned to the node */
export type Template_Login = ContentTemplate & {
  __typename?: 'Template_Login';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};

/** The template assigned to the node */
export type Template_NoSidebar = ContentTemplate & {
...
/** The template assigned to the node */
export type Template_RightSidebar = ContentTemplate & {
  __typename?: 'Template_RightSidebar';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};
