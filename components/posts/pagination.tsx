...
export const Pagination = ({
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between px-2 py-3 border-t border-outer_space-200 bg-brand-100 font-display sm:px-6">
        {hasPreviousPage && (
          <Link
            href={`${path}${currentPage - 1}`}
            className="relative inline-flex items-center justify-center px-2 py-2 text-sm font-medium align-middle bg-white border border-outer_space-300 rounded-l-md text-azure_radiance-900 hover:bg-outer_space-50"
        ...
        >
          <ul className="flex flex-row">
            {hasPrevDots && (
              <li className="relative inline-flex items-center px-2 py-2 text-sm font-medium bg-white border border-outer_space-300 text-azure_radiance-900 hover:bg-outer_space-50">
                <Dots
            ...
            {pages.map((page) => {
              ...
              return active ? (
                <li
                  key={page}
                  className="relative inline-flex items-center px-2 py-2 text-sm font-medium bg-white border text-outer_space-500 border-outer_space-300 hover:bg-outer_space-50"
                >
                  <span
                ...
                <li
                  key={page}
                  className="relative inline-flex items-center px-2 py-2 text-sm font-medium bg-white border border-outer_space-300 text-azure_radiance-900 hover:bg-outer_space-50"
                >
                  <Link
                    href={`${path}${page}`}
