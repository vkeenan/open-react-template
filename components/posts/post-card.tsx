  ...
  return (
    <div className='w-full px-1 my-1 md:w-1/2 lg:my-2 lg:w-1/3 lg:px-2'>
      <article className='overflow-hidden bg-white rounded-none shadow-md'>
        ...
        <header className='flex items-center justify-between p-2 font-semibold leading-none bg-brand-50 text-brand-900 hover:bg-brand-900 hover:text-brand-50 md:p-4'>
