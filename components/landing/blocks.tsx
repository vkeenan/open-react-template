  ...
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-outer_space-800">
          {/* Section header */}
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center">
              ...
              >
                ...
                />
                <path
                  className="stroke-current text-apple-100"
                ...
                />
                <path
                  className="stroke-current text-apple-300"
              ...
              <p className="text-lg text-outer_space-400 text-center">
